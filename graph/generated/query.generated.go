...
func (ec *executionContext) field_Query_getCategory_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_getCategory_argsCategoryID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_getCategory_argsCategoryID(
	ctx context.Context,
	rawArgs map[string]any,
) (*string, error) {
...
func (ec *executionContext) _Query_getCategory(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetCategory(rctx, fc.Args["categoryID"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOCategory2ᚕᚖThaiLyᚋgraphᚋmodelᚐCategory(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Query_getCategory(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "deleted":
				return ec.fieldContext_Category_deleted(ctx, field)
			case "slug":
				return ec.fieldContext_Category_slug(ctx, field)
			case "product":
				return ec.fieldContext_Category_product(ctx, field)
			}
